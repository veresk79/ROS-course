...
(cl:defmethod cl:initialize-instance :after ((m <location>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'location)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name message-msg:<location> is deprecated: use message-msg:location instead.")))
...
(cl:defmethod z-val ((m <location>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader message-msg:z-val is deprecated.  Use message-msg:z instead.")
  (z m))
